            ...
            <div class="layui-form-item" style="margin-bottom: 10px!important;">
                ...
                <div class="layui-input-inline">
                    <div class="layui-input-inline" style="margin-left: 5px;">
                        <input type="text" name="SearchID" id="SearchID" required style="width: 200px;" placeholder="请输入管理员ID" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <label class="layui-form-label">姓名</label>
                <div class="layui-input-inline">
                    <div class="layui-input-inline" style="margin-left: 5px;">
                        <input type="text" name="SearchName" id="SearchName" required style="width: 200px;" placeholder="请输入姓名" autocomplete="off" class="layui-input">
                    </div>
                </div>
